...
# Add your Razorpay API credentials here
KEY_ID = "your_actual_key_id"  # Replace with your Razorpay Key ID
KEY_SECRET = "your_actual_key_secret"  # Replace with your Razorpay Key Secret
